...
import Method from '../../../../features/topic/Integration/Rectangle'
...
const RectanglePage = () => {
	...
	return (
		<div className={style.rectanglePage}>
			...
			<div className={style.methodSelect}>
				<label>
					Выберите метод:
					<select value={method} onChange={handleMethodChange}>
						<option value='left'>Метод Левого Прямоугольника</option>
						<option value='right'>Метод Правого Прямоугольника</option>
						<option value='middle'>Метод Среднего Прямоугольника</option>
					</select>
				</label>
			</div>
