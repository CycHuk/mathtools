...
import MethodNewton from '../../../../features/topic/NonlinearEquations/methodNewton'

import style from './Newton.module.scss'
...
const NewtonPage = () => {
	...
	const solveSystem = () => {
		try {
			...
			const solution = MethodNewton(func, a, b, precision)
	...
	return (
		<div className={style['container']}>
			<h1 className={style['header']}>Метод Ньютона</h1>
