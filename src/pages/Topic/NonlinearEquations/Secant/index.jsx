...
import MethodSecant from '../../../../features/topic/NonlinearEquations/methodSecant'

import style from './Secant.module.scss'
...
const SecantPage = () => {
	...
	const solveSystem = () => {
		try {
			...
			const solution = MethodSecant(func, a, b, precision)
	...
	return (
		<div className={style['container']}>
			<h1 className={style['header']}>Метод Секущих</h1>
