...
import MethodGoldenSection from '../../../../features/topic/NonlinearEquations/methodGoldenSection'

import style from './GoldenSection.module.scss'

import 'katex/dist/katex.min.css'
import Latex from 'react-latex-next'

const GoldenSectionPage = () => {
	...
	const solveSystem = () => {
		try {
			...
			const solution = MethodGoldenSection(func, a, b, precision)
	...
	return (
		<div className={style['container']}>
			<h1 className={style['header']}>Метод Золотого сечения</h1>
...
export default GoldenSectionPage
